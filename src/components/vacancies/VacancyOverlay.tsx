                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <div className="flex items-center gap-2 bg-purple-50 text-purple-700 px-4 py-2 rounded-full">
                        <span className="font-medium">опыт: {vacancy.experience}</span>
                      </div>
                    </div>
                      ...
                      <div className="text-gray-700 leading-relaxed space-y-4">
                        {vacancy.description && (
                          <div className="whitespace-pre-wrap text-base md:text-lg">
                            {vacancy.description.replace(/Присоединяйтесь к нашей профессиональной команде и получите стабильную работу с отличными условиями и достойной оплатой труда\.\s*/g, "")}
                          </div>
                        )}
                    ...
                    {vacancy.requirements && typeof vacancy.requirements === 'string' && vacancy.requirements.trim() && (
                      <div className="prose max-w-none">
